...
test("Like", () => {
  const findOptions = filterParser.generateQueryFindOptions({
    filter: [
      { field: "test", type: FilterOperationType.Contains, value: "%val%" },
    ],
  });
...
test("Ilike", () => {
  const findOptions = filterParser.generateQueryFindOptions({
    filter: [
      { field: "test", type: FilterOperationType.IContains, value: "%val%" },
    ],
  });
...
test("Ilike for number", () => {
  const findOptions = filterParser.generateQueryFindOptions({
    filter: [
      { field: "test", type: FilterOperationType.IContains, value: "5" },
    ],
  });
  expect(findOptions.where.test).toEqual({
    contains: "5",
...
test("StartsWith", () => {
  const findOptions = filterParser.generateQueryFindOptions({
    filter: [
      { field: "test", type: FilterOperationType.StartsWith, value: "5" },
    ],
  });
...
test("IStartsWith", () => {
  const findOptions = filterParser.generateQueryFindOptions({
    filter: [
      { field: "test", type: FilterOperationType.IStartsWith, value: "5" },
    ],
  });
  expect(findOptions.where.test).toEqual({
    startsWith: "5",
...
test("IEndsWith", () => {
  const findOptions = filterParser.generateQueryFindOptions({
    filter: [
      { field: "test", type: FilterOperationType.IEndsWith, value: "5" },
    ],
  });
  expect(findOptions.where.test).toEqual({
    endsWith: "5",
